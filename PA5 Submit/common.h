...
class quit_msg // class that can be used to create an object that contains NEWCHANNEL_MSG
{
public:
    MESSAGE_TYPE mtype;
    quit_msg(){
...
class new_channel_msg // class that can be used to create an object that contains NEWCHANNEL_MSG
{
public:
    MESSAGE_TYPE mtype;
    new_channel_msg(){
